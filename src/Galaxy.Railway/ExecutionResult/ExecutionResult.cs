...
namespace Galaxy.Railway
{
    public class ExecutionResult : IExecutionResult
    {
        ...
        public static ExecutionResult Fail(IEnumerable<string> errors) => new FailedExecutionResult(errors);
        public static ExecutionResult Fail(params string[] errors) => new FailedExecutionResult(errors);
